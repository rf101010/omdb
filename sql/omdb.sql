...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 28, 2020 at 08:31 PM
...
INSERT INTO `metadata` (`local_name`, `language`, `country`, `plot`, `genre`, `trivia`, `keywords`, `movie_ID`) VALUES
('Vertigo', 'English', 'United States', 'A former police detective juggles wrestling with his personal demons and becoming obsessed with a hauntingly beautiful woman.', 'mystery', 'The opening title sequence designed by Saul Bass makes this the first movie to use computer graphics.', 'Hitchcock, romantic obsession, 1950s, acrophobia, ', 2);
...
INSERT INTO `movies` (`movie_ID`, `local_name`, `english_name`, `year_made`) VALUES
...
INSERT INTO `movie_media` (`media_ID`, `media_link`, `media_type`, `movie_ID`) VALUES
(1, 'https://www.imdb.com/title/tt0052357/mediaviewer/rm4007330816', 'poster', 2);
...
INSERT INTO `person` (`person_ID`, `gender`, `name`, `movie_ID`) VALUES
(1, 'male', 'Alfred Hitchcock', 2),
(2, 'male', 'James Stewart', 2),
(3, 'female', 'Kim Novak', 2),
(4, 'female', 'Barbara Bel Geddes', 2),
(5, 'male', 'Tom Helmore', 2),
(6, 'male', 'Henry Jone', 2),
(7, 'male', 'Raymond Bailey', 2),
(8, 'female', 'Ellen Corby', 2),
(9, 'male', 'Bernard Hermann', 2);
...
INSERT INTO `song` (`song_ID`, `title`, `lyrics`, `movie_ID`) VALUES
(1, 'Soundtrack Suite', 'none', 2);
...
INSERT INTO `song_media` (`song_media_ID`, `link`, `link_type`, `song_ID`) VALUES
(1, 'https://www.youtube.com/watch?v=Txvgd60hLPk', 'youtube video', 1);
...
--
ALTER TABLE `metadata`
  ADD CONSTRAINT `metadata_ibfk_1` FOREIGN KEY (`movie_ID`) REFERENCES `movies` (`movie_ID`);
...
--
ALTER TABLE `movie_person`
  ADD CONSTRAINT `movie_person_ibfk_1` FOREIGN KEY (`movie_ID`) REFERENCES `movies` (`movie_ID`),
  ADD CONSTRAINT `movie_person_ibfk_2` FOREIGN KEY (`person_ID`) REFERENCES `person` (`person_ID`);

--
-- Constraints for table `movie_song`
--
ALTER TABLE `movie_song`
  ADD CONSTRAINT `movie_song_ibfk_1` FOREIGN KEY (`movie_ID`) REFERENCES `movies` (`movie_ID`),
  ADD CONSTRAINT `movie_song_ibfk_2` FOREIGN KEY (`song_ID`) REFERENCES `song` (`song_ID`);
...
--
ALTER TABLE `song`
  ADD CONSTRAINT `song_ibfk_1` FOREIGN KEY (`movie_ID`) REFERENCES `movies` (`movie_ID`);

--
-- Constraints for table `song_media`
--
ALTER TABLE `song_media`
  ADD CONSTRAINT `song_media_ibfk_1` FOREIGN KEY (`song_ID`) REFERENCES `song` (`song_ID`);

--
-- Constraints for table `song_person`
--
ALTER TABLE `song_person`
  ADD CONSTRAINT `song_person_ibfk_1` FOREIGN KEY (`person_ID`) REFERENCES `person` (`person_ID`),
  ADD CONSTRAINT `song_person_ibfk_2` FOREIGN KEY (`song_ID`) REFERENCES `song` (`song_ID`);
COMMIT;
